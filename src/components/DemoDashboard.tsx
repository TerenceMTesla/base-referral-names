...
export const DemoDashboard = () => {
  ...
  const mockReferrals = [
    { id: '1', referral_code: 'DEMO-REF-12345', referred_email: 'user1@ezens.eth', status: 'verified', created_at: '2024-01-15' },
    { id: '2', referral_code: 'DEMO-REF-12345', referred_email: 'user2@ezens.eth', status: 'verified', created_at: '2024-01-14' },
    { id: '3', referral_code: 'DEMO-REF-12345', referred_email: 'user3@ezens.eth', status: 'pending', created_at: '2024-01-13' },
  ];

  const mockSubnames = [
    { id: '1', subname: 'rewards.ezens.eth', referral_count: 10, nft_token_id: '1001', created_at: '2024-01-10' },
    { id: '2', subname: 'bonus.ezens.eth', referral_count: 8, nft_token_id: '1002', created_at: '2024-01-12' },
  ];

  const mockLeaderboard = [
    { user_id: '1', display_name: 'DemoUser', email: 'demo@ezens.eth', total_referrals: 24, verified_referrals: 18, subnames_earned: 2, rank: 1 },
    { user_id: '2', display_name: 'TopReferrer', email: 'top@ezens.eth', total_referrals: 45, verified_referrals: 32, subnames_earned: 4, rank: 2 },
    { user_id: '3', display_name: 'ActiveUser', email: 'active@ezens.eth', total_referrals: 38, verified_referrals: 28, subnames_earned: 3, rank: 3 },
  ];
    ...
    <div className="space-y-8">
      <div className="text-center space-y-4 animate-fade-in">
        <div className="flex items-center justify-center gap-3">
          ...
          <h1 className="text-5xl font-bold text-gradient">EZENS Referral Hub</h1>
        </div>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Explore EZENS referral system with sample data and experience the power of ENS subname rewards
        </p>
      ...
      <Tabs defaultValue="share" className="space-y-6">
        ...
        <TabsContent value="share" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Share Your ezens.eth Referral Link</CardTitle>
              <CardDescription>
                Share this link with friends to earn ENS subname NFT rewards when they join ezens.eth
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="bg-muted p-4 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  <strong>How it works:</strong> When someone joins ezens.eth using your link, 
                  you'll earn progress towards exclusive ENS subname NFT rewards. Every 10 verified referrals 
                  unlocks a new collectible ENS subname NFT on ezens.eth!
                </p>
              </div>
            </CardContent>
          </Card>
